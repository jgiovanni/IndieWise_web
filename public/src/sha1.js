...
(function(E) {
    function t(e, a, c) {
        ...
        if ("SHA-1" === e) m = 512, w = z, n = F, h = 160;
        ...
        this.getHash = function(a, c) {
            ...
            if (!1 === q)
                for (k = n(b, d, g, k), l = 1; l < v; l += 1) k = n(k, h, 0, x(e));
            q = !0;
            return f(k)
        };
    ...
    function C(e,
        ...
        var c = "",
            ...
            b, d, f;
        for (b = 0; b < g; b += 3)
            for (f = b + 1 >>> 2, d = e.length <= f ? 0 : e[f], f = b + 2 >>> 2, f = e.length <= f ? 0 : e[f], f = (e[b >>> 2] >>> 8 * (3 - b % 4) & 255) << 16 | (d >>> 8 * (3 - (b + 1) % 4) & 255) << 8 | f >>> 8 * (3 - (b + 2) % 4) & 255, d = 0; 4 > d; d += 1) 8 * b + 6 * d <= 32 * e.length ? c += "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(f >>> 6 * (3 - d) & 63) : c += a.b64Pad;
        return c
    }
    ...
    function x(e) {
        if ("SHA-1" === e) e = [1732584193, 4023233417, 2562383102, 271733878, 3285377520];
