    ...
    .directive('accordionGroup', function() {
      ...
      return {
        ...
        controller: ['$scope', '$attrs', '$parse',
          function accordionGroupController($scope, $attrs, $parse) {
            'ngInject';
...
(function() {
  angular.module("mm.foundation.accordion").run(["$templateCache",
...
angular.module("mm.foundation.alert", []).controller('AlertController', ['$scope', '$attrs',
...
(function() {
  angular.module("mm.foundation.alert").run(["$templateCache",
    function($templateCache) {
...
(function() {
  angular.module("mm.foundation.dropdownToggle").run(["$templateCache",
    function($templateCache) {
...
angular.module('mm.foundation.mediaQueries', []).factory('matchMedia', ['$document', '$window',
 ...
 */
    .directive('modalBackdrop', ['$modalStack',
      ...
      function($window, $timeout, $document, $compile, $rootScope, $$stackedMap, $animate, $q, mediaQueries) {
        'ngInject';
      ...
      var $modalProvider = {
        ...
        $get: ['$injector', '$rootScope', '$q', '$http', '$templateCache', '$controller', '$modalStack',
          function $get($injector, $rootScope, $q, $http, $templateCache, $controller, $modalStack) {
            'ngInject';
...
(function() {
  angular.module("mm.foundation.modal").run(["$templateCache",
    function($templateCache) {
...
angular.module('mm.foundation.offcanvas', []).directive('offCanvasWrapper', ['$window',
  function($window) {
    'ngInject';
...
angular.module('mm.foundation.pagination', []).controller('PaginationController', ['$scope', '$attrs', '$parse', '$interpolate',
...
(function() {
  angular.module("mm.foundation.pagination").run(["$templateCache",
    function($templateCache) {
...
angular.module('mm.foundation.progressbar', []).constant('progressConfig', {
  animate: true,
  max: 100
}).controller('ProgressController', ['$scope', '$attrs', 'progressConfig', '$animate',
  function($scope, $attrs, progressConfig, $animate) {
    'ngInject';
...
(function() {
  angular.module("mm.foundation.progressbar").run(["$templateCache",
    function($templateCache) {
...
(function() {
  angular.module("mm.foundation.rating").run(["$templateCache",
    function($templateCache) {
...
angular.module('mm.foundation.tabs', []).controller('TabsetController', ['$scope',
...
(function() {
  angular.module("mm.foundation.tabs").run(["$templateCache",
    function($templateCache) {
 ...
 */
     ...
     *   });
       ...
       */
      this.$get = ['$window', '$compile', '$timeout', '$parse', '$document', '$position', '$interpolate', '$animate',
        function($window, $compile, $timeout, $parse, $document, $position, $interpolate, $animate) {
          'ngInject';
...
(function() {
  angular.module("mm.foundation.tooltip").run(["$templateCache",
    function($templateCache) {
