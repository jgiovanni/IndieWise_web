<div class="off-canvas position-right light-off-menu" id="NotificationsArea" data-off-canvas data-close-on-click="false" data-force-top="true">
    <div class="off-menu-close">
        <h3>Notifications</h3>
        <span class="right-off-canvas-toggle"><i class="fa fa-times fa-2x"></i></span>
    </div>
    <ul class="vertical menu off-menu notification-list" off-canvas-nav off-canvas-list>
