...
import {ILocationProvider, ILocationService, IQService} from "angular";
import {IStateProvider, IStateParamsService, IUrlRouterProvider} from "angular-ui-router";
...
module IndieWise {
        ...
        .config(['$stateProvider', '$urlRouterProvider', '$locationProvider', 'BASE', function ($stateProvider: IStateProvider, $urlRouterProvider: IUrlRouterProvider, $locationProvider: ILocationProvider, BASE: string) {
            ...
            $stateProvider
                ...
                .state('video_critique', {
                    ...
                    authenticate: false,
                    template: '<critique critique="$resolve.Critique"></critique>',
                ...
                .state('video_critique-edit', {
                    ...
                    authenticate: true,
                    template: '<critique-edit critique="$resolve.Critique"></critique-edit>',
                ...
                .state('profile.upload', {
                    ...
                    resolve: {
                        Access: ['$rootScope', 'DataService', 'AuthService', '$q', function ($rootScope, DataService: IDataService, AuthService: IAuthService, $q: IQService) {
                ...
                .state('profile.videos', {
                    ...
                    resolve: {
                        Videos: ['AuthService', 'DataService', function (AuthService: IAuthService, DataService: IDataService) {
                ...
                .state('profile.critiques', {
                    ...
                    resolve: {
                        Critiques: ['AuthService', 'DataService', function (AuthService: IAuthService, DataService: IDataService) {
                ...
                .state('profile.settings', {
                    ...
                    resolve: {
                        ...
                        UserTypes: ['AuthService', 'DataService', '$q', function (AuthService: IAuthService, DataService: IDataService, $q: IQService) {
                ...
                .state('messages', {
                    url: '/messages',
                    authenticate: true,
                    template: '<messages conversations="$resolve.Conversations"></messages>',
                    resolve: {
                        Conversations: ['DataService', function (DataService: IDataService) {
    ...
    function IndieWiseRun($rootScope, $state, $stateParams: IStateParamsService, AuthService: IAuthService, UtilsService, DataService: IDataService, $http, $timeout, $transitions, StreamConfig, anchorSmoothScroll, amMoment, $intercom, FacebookAngularPatch, socket) {
