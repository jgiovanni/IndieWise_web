<template>
    ...
    <section class="main-preview-player">
        <video id="video" class="video-js vjs-default-skin vjs-16-9 vjs-big-play-centered vjs-fluid" controls preload="auto" crossorigin="anonymous">
...
//                    thumbnail: video.thumbnail_url || 'https://getindiewise.com/assets/img/default_video_thumbnail.jpg',
        ...
        mounted(){
            ...
            player.on('loadstart', function(e) {
                ...
                player.socialShare({
                    facebook: { // optional, includes a Facebook share button (See the [Facebook documentation](https://developers.facebook.com/docs/sharing/reference/share-dialog) for more information)
                        ...
                        shareImage: plitem.thumbnail_url, // optional, defaults to the Facebook-scraped image
            ...
            let throttledWatcher = _.throttle(this.markAsWatched);
