...
class Thread extends Model
{
    ...
    {
        return $this->messages->last()->user;
    }
    ...
    public function isUnread($userId)
    {
        try {
            ...
            //No longer need ModelNotFound exception as we're not performing another query
    ...
    {
        // we already have participants collection because of eager loading so we just need to filter it
